...
Our task is to find the constant term i.e, ‘c’ of the polynomial with the given roots. However, the points are not provided directly but in a specific format.
We need to read the input from the test cases provided in JSON format.
